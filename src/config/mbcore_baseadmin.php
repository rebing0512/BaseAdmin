...
return [
    ...
    'baseadmin_assets_path' =>'/assets/MBCore/BaseAdmin',  //设置发布后样式路径
    ...
    'baseadmin_system_name' => 'MBCore',  //显示公司名称，不设置默认显示MBCore
    ...
    'baseadmin_login_footer' => '&copy; MBCore.COM',  //是否显示登录页底部文字，'' 不显示，默认 &copy; MBCore.COM,否则自定义
